...
func TestABI_Read(t *testing.T) {
	...
	testCases := []map[string]interface{}{
		...
		{"caseName": "public_key", "typeName": "public_key", "value": "\"GLS1111111111111111111111111111111114T1Anm\"", "encode": ecc.MustNewPublicKey("GLS1111111111111111111111111111111114T1Anm"), "expectedError": nil, "isOptional": false, "isArray": false, "fieldName": "testedField"},
		{"caseName": "signature", "typeName": "signature", "value": "\"96L1au4xFJg5edn6qBK6UDbSsC2RKsMs4cXCA2LoCPZxBDMXehdZFWPh1GeRhzGoQjBwNK2eBmUXf4L8SBApL69pGdUJm\"", "encode": ecc.Signature{Curve: ecc.CurveK1, Content: signatureBuffer[1:]}, "expectedError": nil, "isOptional": false, "isArray": false, "fieldName": "testedField"},
